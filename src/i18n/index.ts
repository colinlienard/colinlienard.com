const ui = {
	fr: {
		...
		'hero.contributions': 'contributions sur la dernière année',
		'experience.title': 'Expérience',
		'experience.mobsuccess.role.fullstack': 'Full-Stack Engineer chez',
		'experience.mobsuccess.period.fullstack': '2025 - Présent, Paris (distanciel)',
		'experience.mobsuccess.role.frontend': 'Développeur Front-End',
		'experience.mobsuccess.period.frontend': '2023 - 2025',
		...
		'contact.linkedin.headline': 'Full-Stack Engineer',
		'contact.linkedin.location': 'Limoges, France',
		'contact.linkedin.cta': 'Se connecter',
		'contact.malt.availability': 'Disponible pour une mission',
	...
	en: {
		'menu.role': 'Full-Stack Engineer',
		'menu.available': 'Available from September',
		...
		'hero.contributions': 'contributions in the last year',
		'experience.title': 'Experience',
		'experience.mobsuccess.role.fullstack': 'Full-Stack Engineer at',
		'experience.mobsuccess.period.fullstack': '2025 - Present, Paris (remote)',
		'experience.mobsuccess.role.frontend': 'Front-End Developer',
		'experience.mobsuccess.period.frontend': '2023 - 2025',
		'experience.mobsuccess.b1':
			'Built web applications used by major French companies to run their advertising campaigns.',
		'experience.mobsuccess.b2':
			'Created an AI assistant letting users ask questions and trigger agentic actions.',
		...
		'experience.connivence.role': 'Front-End Developer (apprenticeship) at',
		'experience.connivence.period': '2021 - 2022, Limoges',
		'experience.connivence.b1':
		...
		'contact.malt.availability': 'Available for freelance work',
