...
export const ui = {
	fr: {
		...
		'hero.p1.mid2': ' et je suis habitué à travailler en ',
		...
		'hero.p2.post': '.',
		'hero.p3.pre': 'En parallèle, je conçois et maintiens des projets ⭐ ',
	...
	en: {
		...
		'hero.p2.post': '.',
		'hero.p3.pre': 'On the side, I design and maintain ⭐ ',
		'hero.p3.link': 'open-source',
