...
export const ui = {
	fr: {
		...
		'experience.mobsuccess.b3.tooltip':
			'Temps de chargement des applications réduit de 1,2 s et durée des runs de tests réduite de 22 %.',
	...
	en: {
		...
		'about.s3.pre': 'On the side, I design and maintain ',
		'about.s3.link': 'open-source projects',
		'about.s3.post': 'used daily by hundreds of developers.',
		...
		'experience.mobsuccess.b3.tooltip': 'Cut app load time by 1.2s and test-run duration by 22%',
